...
namespace Chap21library
{
    public class MessageUtil
    {
        public static void Send(Stream writer, Message1 msg)
        {
            writer.Write(msg.GetBytes(), 0, msg.GetSize());
        }
        public static Message1 Receive(Stream reader)
        {
            int totalRecv = 0;
            int sizeToRead = 16;
            ...
            return new Message1() { Header = header, Body = body };
        }
     }
}
